...
// Apple platform (macOS/iOS) - include compatibility types
#include "Apple/AppleTypes.h"
#include "Apple/AppleMaths.h"
...
#include "../Minecraft.World/PerformanceTimer.h"
	...
	#include "Apple/4JLibs/inc/4J_Input.h"
	#include "Apple/4JLibs/inc/4J_Profile.h"
	#include "Apple/4JLibs/inc/4J_Render.h"
	#include "Apple/4JLibs/inc/4J_Storage.h"
...
#elif defined _APPLE_PLATFORM
	#include "Apple/Sentient/MinecraftTelemetry.h"
	#include "AppleMedia/strings.h"
	#include "Apple/Apple_App.h"
	#include "Apple/Sentient/DynamicConfigurations.h"
	#include "Apple/Sentient/SentientTelemetryCommon.h"
	#include "Apple/GameConfig/Minecraft.spa.h"
	#include "Apple/XML/ATGXmlParser.h"
	#include "Apple/Social/SocialManager.h"
	#include "Common/Audio/SoundEngine.h"
	#include "Apple/Iggy/include/iggy.h"
	#include "Apple/Iggy/gdraw/gdraw_metal.h"
	#include "Apple/UIController/Apple_UIController.h"
#elif defined _WINDOWS64
